...
if(!socket) then
	hook.Add("HUDPaint", "PIPE-Error", function()
		...
		draw.SimpleText("To play on this server properly, you must get the gm_luasocket addon from http://icannt.org", "ScoreboardText", ScrW()/2, ScrH()/2, Color(255,0,0,255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER);
	end);
end
